    ...
    return (
        <section className={`space-y-1 ${className ? className : ""}`}>
            <div className="flex justify-between items-end gap-6">
                <h2 className="text-lg font-bold line-clamp-1 text-clip break-all">{heading.body}</h2>
                {heading.button && (
                    <Link href={heading.button.href} className="text-sm font-light text-ipm-magenta-light shrink-0 hover-75">
